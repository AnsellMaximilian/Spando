...
export default function Hero() {
  return (
    <section className="relative bg-right-top bg-no-repeat bg-contain h-60 text-center md:text-left lg:h-125 md:bg-hero-md">
      <div className="container h-full mx-auto p-4 flex flex-col justify-center">
